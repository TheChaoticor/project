...
function App() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      if (
        !data ||
        typeof data.isDeepfake !== "boolean" ||
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:w-1/2">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Protect yourself from digital deception. Our advanced AI
              technology detects manipulated media with 99.9% accuracy.
            </p>
              ...
              {!file && (
                <>
                  ...
                  <p className="text-gray-400 mb-6">
                    Supported formats: JPG, PNG, MP4, MP3, WAV (max 10MB)
                  </p>
                  <input
                    type="file"
                    id="file-upload"
                  ...
                  <div className="max-w-lg mx-auto">
                    ...
                    {file.type.startsWith("audio/") && (
                      <audio
                        src={preview!}
                        controls
                        className="rounded-lg shadow-lg max-h-[100px] mx-auto"
                      />
                    )}
                  </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-6">
              ...
              <span className="text-gray-400">
                © 2024 DeepGuard. All rights reserved.
              </span>
            </div>
          </div>
        </div>
